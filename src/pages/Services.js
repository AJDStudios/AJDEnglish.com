    ...
    <div className="services-page">
        ...
        <section className="services-list">
            ...
            <div className="service-item">
                ...
                <button className="info-btn">Request More Information</button>
            </div>
        </section>
        ...
        <section className="booking-calendar">
            <h2>Check Availability & Book a Lesson</h2>
        ...
        <section className="payment-info">
            ...
            <p>Payments are handled via PayPal after booking. You will receive a confirmation email with payment instructions. </p>
            <button className="payment-btn">Go to PayPal</button> 
        </section>
        ...
        <section className="cta-section">
            ...
            >
            Contact</button> for custom solutions.</p>
        </section>
    </div>
  );
};
